...
public final class Evaluation {
     ...
     * @return Retourne la distance parcourue (ou Double.MAX_VALUE si le chemin est invalide ou si le temps est écoulé)
     */
    ...
    /**
     * @param path Le chemin à évaluer
     * @return Retourne la distance parcourue SANS vérifier si le chemin est valide
